...
def build_admin_dashboard():
    ...
    return {
        ...
        "admin_links": [
            {"label": "Manage content assets", "url": "/admin/prep/contentasset/"},
            {"label": "Review question bank", "url": "/admin/prep/question/"},
            {"label": "Inspect prediction sets", "url": "/admin/prep/predictionset/"},
            {"label": "Monitor test sessions", "url": "/admin/prep/testsession/"},
            {"label": "Open delivery logs", "url": "/admin/prep/telegramdeliverylog/"},
